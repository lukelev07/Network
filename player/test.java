...
public class test {
	public static void main (String[] args) {
		...
		Move hello1 = temp.chooseMove();
		Move hello2 = temp.chooseMove();
		Move hello3 = temp.chooseMove();
		...
		Move[] movetemp= test2.validMoves(0);
		System.out.println(Board.printString(movetemp));
